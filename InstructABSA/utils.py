...
class T5Generator:
    ...
    def tokenize_function_inputs(self, sample):
        ...
        labels = self.tokenizer(
            sample["labels"], max_length=64, truncation=True)
...
class T5Classifier:
    ...
    def tokenize_function_inputs(self, sample):
        ...
        sample['input_ids'] = self.tokenizer(
            sample["text"], max_length=512, truncation=True).input_ids
        sample['labels'] = self.tokenizer(
            sample["labels"], max_length=64, truncation=True).input_ids
        return sample
    ...
    def get_metrics(self, y_true, y_pred):
        return precision_score(y_true, y_pred, average='macro'), recall_score(y_true, y_pred, average='macro'), \
            f1_score(y_true, y_pred, average='macro'), accuracy_score(
                y_true, y_pred)
